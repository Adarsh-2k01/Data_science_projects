...
## 📁 Contents
- **Module_4 Project.pptx** – contains SQL code explanations, outputs, insights, and the video walkthrough link.
...
- Date-based Analysis (Monthly sales trends)  
- Profit & Revenue Analysis  
- Writing business-focused insights from query results 
